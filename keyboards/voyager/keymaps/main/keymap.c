...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_NO,          KC_NO,          KC_NO,          LALT(LGUI(LCTL(KC_0))),KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    LGUI(KC_Z),     LALT(LGUI(LCTL(KC_5))),LALT(LGUI(LCTL(KC_6))),LALT(LGUI(LCTL(KC_7))),LALT(LGUI(LCTL(KC_8))),LALT(LGUI(LCTL(KC_9))),                                LALT(LGUI(LCTL(KC_1))),LALT(LGUI(LCTL(KC_2))),LALT(LGUI(LCTL(KC_3))),LALT(LGUI(LCTL(KC_4))),KC_TRANSPARENT, KC_NO,          
    KC_NO,          KC_NO,          KC_NO,          LGUI(KC_C),     KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
