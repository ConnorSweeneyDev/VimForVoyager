...
#        if defined(STM32F10X_LD_VL) || defined(STM32F10X_MD_VL) || defined(STM32F10X_HD_VL) || defined(STM32F10X_LD) || defined(STM32F10X_MD) || defined(STM32F10X_HD) || defined(STM32F10X_XL) || defined(STM32F10X_CL)
...
#        if STM32_I2C_USE_I2C1 && !OSAL_IRQ_IS_VALID_PRIORITY(STM32_I2C_I2C1_IRQ_PRIORITY)
#            error "Invalid IRQ priority assigned to I2C1"
#        endif

#        if STM32_I2C_USE_I2C2 && !OSAL_IRQ_IS_VALID_PRIORITY(STM32_I2C_I2C2_IRQ_PRIORITY)
#            error "Invalid IRQ priority assigned to I2C2"
#        endif

#        if STM32_I2C_USE_I2C3 && !OSAL_IRQ_IS_VALID_PRIORITY(STM32_I2C_I2C3_IRQ_PRIORITY)
#            error "Invalid IRQ priority assigned to I2C3"
#        endif

#        if STM32_I2C_USE_I2C1 && !STM32_DMA_IS_VALID_PRIORITY(STM32_I2C_I2C1_DMA_PRIORITY)
#            error "Invalid DMA priority assigned to I2C1"
#        endif

#        if STM32_I2C_USE_I2C2 && !STM32_DMA_IS_VALID_PRIORITY(STM32_I2C_I2C2_DMA_PRIORITY)
#            error "Invalid DMA priority assigned to I2C2"
#        endif

#        if STM32_I2C_USE_I2C3 && !STM32_DMA_IS_VALID_PRIORITY(STM32_I2C_I2C3_DMA_PRIORITY)
...
#            if STM32_I2C_USE_I2C1 && (!defined(STM32_I2C_I2C1_RX_DMA_STREAM) || !defined(STM32_I2C_I2C1_TX_DMA_STREAM))
#                error "I2C1 DMA streams not defined"
#            endif

#            if STM32_I2C_USE_I2C2 && (!defined(STM32_I2C_I2C2_RX_DMA_STREAM) || !defined(STM32_I2C_I2C2_TX_DMA_STREAM))
#                error "I2C2 DMA streams not defined"
#            endif

/* Check on the validity of the assigned DMA channels.*/
#            if STM32_I2C_USE_I2C1 && !STM32_DMA_IS_VALID_ID(STM32_I2C_I2C1_RX_DMA_STREAM, STM32_I2C1_RX_DMA_MSK)
#                error "invalid DMA stream associated to I2C1 RX"
#            endif

#            if STM32_I2C_USE_I2C1 && !STM32_DMA_IS_VALID_ID(STM32_I2C_I2C1_TX_DMA_STREAM, STM32_I2C1_TX_DMA_MSK)
#                error "invalid DMA stream associated to I2C1 TX"
#            endif

#            if STM32_I2C_USE_I2C2 && !STM32_DMA_IS_VALID_ID(STM32_I2C_I2C2_RX_DMA_STREAM, STM32_I2C2_RX_DMA_MSK)
#                error "invalid DMA stream associated to I2C2 RX"
#            endif

#            if STM32_I2C_USE_I2C2 && !STM32_DMA_IS_VALID_ID(STM32_I2C_I2C2_TX_DMA_STREAM, STM32_I2C2_TX_DMA_MSK)
#                error "invalid DMA stream associated to I2C2 TX"
#            endif

#            if STM32_I2C_USE_I2C3 && !STM32_DMA_IS_VALID_ID(STM32_I2C_I2C3_RX_DMA_STREAM, STM32_I2C3_RX_DMA_MSK)
#                error "invalid DMA stream associated to I2C3 RX"
#            endif

#            if STM32_I2C_USE_I2C3 && !STM32_DMA_IS_VALID_ID(STM32_I2C_I2C3_TX_DMA_STREAM, STM32_I2C3_TX_DMA_MSK)
